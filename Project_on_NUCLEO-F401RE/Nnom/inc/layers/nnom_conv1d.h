#ifndef __NNOM_CONV1D_H__
#define __NNOM_CONV1D_H__
...
typedef struct _nnom_conv1d_layer_t
{
	nnom_layer_t super;
...
// API
nnom_layer_t *Conv1D(uint32_t filters, nnom_3d_shape_t k, nnom_3d_shape_t s, nnom_3d_shape_t d,  nnom_padding_t pad_type, const nnom_weight_t *w, const nnom_bias_t *b);
