#ifndef __NNOM_LOCAL_CONV1D_H__
#define __NNOM_LOCAL_CONV1D_H__
...
void local_convolve1D_HWC_q7_nonsquare(const q7_t *Im_in,                // input time series
...
arm_status arm_convolve1D_HWC_q7_fast(const q7_t *Im_in,
