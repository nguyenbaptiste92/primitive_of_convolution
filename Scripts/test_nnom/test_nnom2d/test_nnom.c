...
#define IMAGE_SIZE (32*32*3)//Adjust to the input size
#define MAX_LINE_LENGTH (IMAGE_SIZE*5) 
#define OUTPUT_SIZE (30*30*16) //Adjust to the output size
...
int main(int argc, char* argv[])
{
  ...
  fprintf(out_shift, "%d\n", CONV2D_OUTPUT_SHIFT); //Adjust to the name of the output shift variable
