#ifndef __NNOM_BNADDCONV2D_H__
#define __NNOM_BNADDCONV2D_H__
...
typedef struct _nnom_bnaddconv2d_layer_t
{
	nnom_layer_t super;
...
} nnom_bnaddconv2d_layer_t;

// a machine interface for configuration
typedef struct _nnom_bnaddconv2d_config_t
{
