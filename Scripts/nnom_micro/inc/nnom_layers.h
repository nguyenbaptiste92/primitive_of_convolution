...
// shift_convolution 2D
nnom_layer_t *ShiftConv2D(uint32_t filters, const nnom_weight_t *w, const nnom_bias_t *b, const nnom_shift_t *shift);

// group_conv1d
nnom_layer_t *GroupConv1D(uint32_t filters, uint32_t groups, nnom_3d_shape_t k, nnom_3d_shape_t s, nnom_3d_shape_t d, nnom_padding_t pad,
					 const nnom_weight_t *w, const nnom_bias_t *b);
                                
// group_conv2d
nnom_layer_t *GroupConv2D(uint32_t filters, uint32_t groups, nnom_3d_shape_t k, nnom_3d_shape_t s, nnom_3d_shape_t d, nnom_padding_t pad,
					 const nnom_weight_t *w, const nnom_bias_t *b);
