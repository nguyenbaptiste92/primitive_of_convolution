...
extern const char default_layer_names[][20];
...
typedef struct _nnom_addconv_parameter
{
    const void *bn_factor;
    uint32_t mode;
    nnom_qformat_param_t shift;
} nnom_addconv_parameter_t;

typedef struct _nnom_shift
{
    const void *p_value;
} nnom_shift_t;
