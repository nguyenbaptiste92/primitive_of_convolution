...
filename = str(Path(__file__).parent/"cc"/"active_shift_2d.so")
_active_shift2d_module = tf.load_op_library(filename)
active_shift2d_op = _active_shift2d_module.active__shift_2d
active_shift2d_grad_op = _active_shift2d_module.active__shift_2d__backprop


@ops.RegisterGradient("Active_Shift_2D")
