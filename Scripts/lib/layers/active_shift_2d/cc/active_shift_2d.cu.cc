...
template struct functor::ASLForward<GPUDevice, float>;
template struct functor::ASL_ShiftBackward<GPUDevice, float>;
template struct functor::ASL_BottomBackward<GPUDevice, float>;
template struct functor::ApplyShiftConstraint<GPUDevice, float>;
template struct functor::setZero<GPUDevice, float>;
template struct functor::setValue<GPUDevice, float>;

template struct functor::ASLForward<GPUDevice, double>;
template struct functor::ASL_ShiftBackward<GPUDevice, double>;
template struct functor::ASL_BottomBackward<GPUDevice, double>;
template struct functor::ApplyShiftConstraint<GPUDevice, double>;
